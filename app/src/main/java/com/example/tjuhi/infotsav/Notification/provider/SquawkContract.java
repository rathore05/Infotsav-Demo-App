...
*/
package com.example.tjuhi.infotsav.Notification.provider;
...
public class SquawkContract {
    ...
    public static final String TECH_KEY = "key_tech";
    public static final String MANAGERIAL_KEY = "key_namagerial";
    public static final String QUIZ_KEY = "key_quiz";
    public static final String ROBOTICS_KEY = "key_robotics";
    public static final String GAMIACS_KEY = "key_gamiacs";
    public static final String GENERAL_KEY = "key_general";
    public static final String TEST_ACCOUNT_KEY = "key_test";


    public static final String[] INSTRUCTOR_KEYS = {
           TECH_KEY, MANAGERIAL_KEY, QUIZ_KEY, ROBOTICS_KEY, GAMIACS_KEY,GENERAL_KEY
    };
